...
Write-Host "   - Base de datos: PostgreSQL EXISTENTE"
Write-Host "   - Usuario DB: [CONFIGURADO]"
...
Write-Host "   DATABASE_URL = postgresql://[usuario]:[password]@[host]:[puerto]/[database]"
Write-Host ""
