    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="mb-8 p-4 bg-white rounded-lg shadow">
        ...
        {Object.keys(filters).length > 0 && (
          <div className="mt-4 p-3 bg-blue-50 rounded-lg">
            ...
            <pre className="text-sm text-blue-600">{JSON.stringify(filters, null, 2)}</pre>
          </div>
        )}
      </div>
      ...
      <div className="mt-8 p-4 bg-gray-50 rounded-lg">
        ...
        <div className="space-y-2 text-sm text-gray-700">
          ...
          <p>
            <strong>3. Props requeridas:</strong>
          </p>
          <ul className="ml-4 list-disc">
            <li>
              <code className="bg-white px-1 rounded">data={tusDatos}</code> - Array con datos para
              sugerencias
            </li>
            <li>
              <code className="bg-white px-1 rounded">section="maquinarias"</code> - Sección actual
            </li>
            <li>
              <code className="bg-white px-1 rounded">onFiltersChange={handleFiltersChange}</code> -
              Callback de filtros
            </li>
          </ul>
          <p>
            <strong>4. Campos con sugerencias automáticas:</strong>
          </p>
          <ul className="ml-4 list-disc">
            <li>
              <strong>Maquinarias:</strong> marca, modelo
            </li>
            <li>
              <strong>Repuestos:</strong> proveedor, categoria
            </li>
            <li>
              <strong>Proveedores:</strong> localidad, nombre
            </li>
            <li>
              <strong>Reparaciones:</strong> tecnico, observaciones
            </li>
          </ul>
        </div>
      </div>
