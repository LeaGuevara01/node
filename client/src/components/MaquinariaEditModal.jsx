      ...
      <div className={MODAL_STYLES.container}>
        <div className={MODAL_STYLES.content}>
          <div className={MODAL_STYLES.header}>
            ...
            <button onClick={onClose} className={MODAL_STYLES.closeButton}>
              ×
            </button>
          </div>
          ...
          <form onSubmit={handleSubmit} className={MODAL_STYLES.form}>
            ...
            <div className={MODAL_STYLES.buttonGroup}>
              ...
              <button type="submit" disabled={loading} className={BUTTON_STYLES.primary}>
                {loading ? (
                  <>
                    <svg
