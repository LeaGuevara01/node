...
const QuickActionCard = ({
  ...
  return (
    <div
      ...
      onMouseEnter={() => {
        if (!isTouch) setShowActions(true);
      }}
      onMouseLeave={() => {
        if (!isTouch) setShowActions(false);
      }}
    >
      {/* Main Content */}
      <div
        ...
        aria-haspopup="true"
        aria-label={
          isTouch ? `${title} - ${showActions ? 'ocultar acciones' : 'mostrar acciones'}` : title
        }
      >
