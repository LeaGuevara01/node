...
const BUTTON_STYLES = {
  ...
  primary: "bg-blue-600 border-transparent text-white hover:bg-blue-700 focus:ring-blue-500 active:bg-blue-800",
  secondary: "bg-white border-gray-300 text-gray-700 hover:bg-gray-50 focus:ring-blue-500 active:bg-gray-100",
  success: "bg-green-600 border-transparent text-white hover:bg-green-700 focus:ring-green-500 active:bg-green-800",
  danger: "bg-red-600 border-transparent text-white hover:bg-red-700 focus:ring-red-500 active:bg-red-800",
  warning: "bg-yellow-600 border-transparent text-white hover:bg-yellow-700 focus:ring-yellow-500 active:bg-yellow-800",
  ghost: "bg-transparent border-transparent text-gray-600 hover:bg-gray-100 focus:ring-gray-500 active:bg-gray-200",
...
export const ActionButtonGroup = ({ 
  ...
  return (
    <div className={`flex items-center space-x-2 ${className}`}>
      {showView && (
        <ViewButton entity={entity} id={id} size={size} />
      )}
      {showEdit && (
        <EditButton entity={entity} id={id} size={size} />
      )}
      {showDelete && (
        <DeleteButton onClick={() => onDelete(id)} size={size} />
      )}
    </div>
  );
};
