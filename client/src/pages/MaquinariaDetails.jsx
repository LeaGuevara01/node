        ...
        <div className={CONTAINER_STYLES.maxWidth}>
          <div className="flex items-center justify-center min-h-64">
            <div className={TEXT_STYLES.loading}>
              <svg
                className={`${ICON_STYLES.medium} ${ICON_STYLES.spin}`}
                fill="none"
                viewBox="0 0 24 24"
              >
                <circle
      ...
      <div className={CONTAINER_STYLES.main}>
        <div className={CONTAINER_STYLES.maxWidth}>
          <div className={`${CONTAINER_STYLES.card} ${CONTAINER_STYLES.cardPadding}`}>
            ...
            <button onClick={() => navigate('/')} className={`${BUTTON_STYLES.secondary} mt-4`}>
  ...
  return (
    <div className={CONTAINER_STYLES.main}>
      <div className={CONTAINER_STYLES.maxWidth}>
        ...
        {uploadSuccess && <div className={ALERT_STYLES.success}>{uploadSuccess}</div>}
                    ...
                    <div className="space-y-4">
                        ...
                        {maquinaria.foto_url ? (
                          ...
                          <div className="w-full h-full flex items-center justify-center">
                            <div className="text-center text-gray-500">
                              <svg
                                className={`${ICON_STYLES.extraLarge} mx-auto mb-3 text-gray-400`}
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
                              >
                      ...
                      <div>
                        <label className="block">
                          ...
                          />
                          <div
                            className={`${uploading ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer hover:bg-gray-50'} w-full text-center transition-all duration-200 p-4 border-2 border-gray-200 rounded-xl hover:border-blue-300`}
                          >
                            {uploading ? (
                              <div className="flex items-center justify-center gap-3">
                                <svg
                                  className={`${ICON_STYLES.small} ${ICON_STYLES.spin} text-blue-600`}
                                  fill="none"
                                  viewBox="0 0 24 24"
                                >
                                  <circle
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                          {maquinaria.estado && (
                            <div className="flex items-center gap-3 p-4 bg-white rounded-lg border border-gray-200">
                              <div
                                className={`flex items-center justify-center w-10 h-10 rounded-lg ${getEstadoColorClass(maquinaria.estado).replace('text-', 'bg-').replace('-700', '-100')}`}
                              >
                                <svg
                                  className={`w-5 h-5 ${getEstadoColorClass(maquinaria.estado)}`}
                                  fill="none"
                                  stroke="currentColor"
                                  viewBox="0 0 24 24"
                                >
                          ...
                          {maquinaria.categoria && (
                            <div className="flex items-center gap-3 p-4 bg-white rounded-lg border border-gray-200">
                              <div
                                className={`flex items-center justify-center w-10 h-10 rounded-lg ${getColorFromString(maquinaria.categoria, 'categoria').replace('text-', 'bg-').replace('-700', '-100')}`}
                              >
                                <svg
                                  className={`w-5 h-5 ${getColorFromString(maquinaria.categoria, 'categoria')}`}
                                  fill="none"
                                  stroke="currentColor"
                                  viewBox="0 0 24 24"
                                >
                          ...
                          {maquinaria.ubicacion && (
                            <div className="flex items-center gap-3 p-4 bg-white rounded-lg border border-gray-200">
                              <div
                                className={`flex items-center justify-center w-10 h-10 rounded-lg ${getColorFromString(maquinaria.ubicacion, 'ubicacion').replace('text-', 'bg-').replace('-700', '-100')}`}
                              >
                                <svg
                                  className={`w-5 h-5 ${getColorFromString(maquinaria.ubicacion, 'ubicacion')}`}
                                  fill="none"
                                  stroke="currentColor"
                                  viewBox="0 0 24 24"
                                >
