                    ...
                    <div className="bg-gray-50 rounded-xl p-4">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div className="flex items-center gap-3 p-4 bg-white rounded-lg border border-gray-200">
                          <div
                            className={`flex items-center justify-center w-10 h-10 rounded-lg ${getStockColorClass(repuesto.stock, repuesto.ubicacion).replace('text-', 'bg-').replace('-700', '-100')}`}
                          >
                            <svg
                              className={`w-5 h-5 ${getStockColorClass(repuesto.stock, repuesto.ubicacion).replace('bg-', 'text-').replace('-100', '-600')}`}
                              fill="none"
                              stroke="currentColor"
                              viewBox="0 0 24 24"
                            >
                        ...
                        {repuesto.categoria && (
                          <div className="flex items-center gap-3 p-4 bg-white rounded-lg border border-gray-200">
                            <div
                              className={`flex items-center justify-center w-10 h-10 rounded-lg ${getColorFromString(repuesto.categoria, 'categoria').replace('text-', 'bg-').replace('-700', '-100')}`}
                            >
                              <svg
                                className={`w-5 h-5 ${getColorFromString(repuesto.categoria, 'categoria')}`}
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
                              >
                        ...
                        {repuesto.ubicacion && (
                          <div className="flex items-center gap-3 p-4 bg-white rounded-lg border border-gray-200">
                            <div
                              className={`flex items-center justify-center w-10 h-10 rounded-lg ${getColorFromString(repuesto.ubicacion, 'ubicacion').replace('text-', 'bg-').replace('-700', '-100')}`}
                            >
                              <svg
                                className={`w-5 h-5 ${getColorFromString(repuesto.ubicacion, 'ubicacion')}`}
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
                              >
