      ...
      <div className="space-y-6 lg:space-y-8">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 md:gap-6">
          ...
          <div className="bg-white p-4 md:p-6 rounded-lg shadow-sm border border-gray-200">
            ...
            <StockSummary data={data.repuestos} stockField="cantidad" mode="discrete" />
          </div>
        </div>
      ...
      <div className="flex flex-wrap justify-center gap-2">
        {definitions.map((def) => {
          ...
          return (
            <span
              key={def.key}
              className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-sm font-medium ${def.class}`}
            >
              <span>{def.label}</span>
