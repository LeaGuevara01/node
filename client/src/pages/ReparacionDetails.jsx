...
function ReparacionDetails({ token }) {
  ...
  const fetchFormData = async () => {
    try {
      ...
      setMaquinarias(
        Array.isArray(maquinariasData) ? maquinariasData : maquinariasData?.maquinarias || []
      );
      ...
      >
        <div className={CONTAINER_STYLES.maxWidth}>
          <div className={`${CONTAINER_STYLES.card} ${CONTAINER_STYLES.cardPadding}`}>
            <div className={ALERT_STYLES.error}>Reparación no encontrada</div>
          </div>
        </div>
      </AppLayout>
    );
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="mt-1 flex items-center">
                  <svg
                    className={`${ICON_STYLES.small} text-gray-400 mr-2`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
              ...
              <div>
                ...
                <div className="mt-1 flex items-center">
                  ...
                  <p className="text-lg text-gray-900">
                    {diasDesdeReparacion(reparacion?.fecha)} días
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="mt-1 flex items-center">
                  ...
                  <p className="text-lg text-gray-900">
                    {reparacion?.maquinaria?.nombre || 'No especificada'}
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="mt-1 flex items-center">
                  ...
                  <p className="text-lg text-gray-900">
                    {reparacion?.usuario?.username || 'No asignado'}
                  </p>
                </div>
              </div>
            ...
            {reparacion.repuestos.map((reparacionRepuesto, index) => (
              <div key={index} className="bg-gray-50 p-4 rounded-lg border">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="text-sm text-gray-500">x{reparacionRepuesto.cantidad}</span>
                </div>
                ...
                {reparacionRepuesto.repuesto?.precio && (
                  <p className="text-sm font-medium text-gray-900">
                    Subtotal: $
                    {(
                      Number(reparacionRepuesto.repuesto.precio) * reparacionRepuesto.cantidad
                    ).toLocaleString()}
                  </p>
                )}
              </div>
