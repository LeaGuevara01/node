...
export const DETAILS_SECTION = {
  ...
  field: "mt-1 p-3 bg-gradient-subtle border border-agricultural-earth-200 rounded-md transition-all duration-200",
  fieldWithIcon: "mt-1 p-3 bg-gradient-subtle border border-agricultural-earth-200 rounded-md flex items-center transition-all duration-200",
  fieldLabel: "block text-sm font-medium text-gray-700 mb-2"
};

// Estilos para imágenes
export const DETAILS_IMAGE = {
  container: "aspect-square bg-gradient-subtle rounded-xl overflow-hidden border-2 border-dashed border-agricultural-earth-300 hover:border-agricultural-crop-400 transition-all duration-300",
  ...
  upload: "block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-medium file:bg-agricultural-crop-50 file:text-agricultural-crop-700 hover:file:bg-agricultural-crop-100 transition-all duration-200",
...
export const DETAILS_TAGS = {
  ...
  tagWithIcon: "inline-flex items-center px-2 py-1 rounded-full text-xs font-medium transition-all duration-200"
};
...
export const DETAILS_ACTIONS = {
  ...
  button: "inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 transition-all duration-200",
  primary: "text-white bg-agricultural-crop-600 hover:bg-agricultural-crop-700 focus:ring-agricultural-crop-500 hover:shadow-glow-green",
  secondary: "text-gray-700 bg-white border-gray-300 hover:bg-gray-50 focus:ring-agricultural-crop-500",
  success: "text-agricultural-crop-700 bg-agricultural-crop-50 border-agricultural-crop-200 hover:bg-agricultural-crop-100 focus:ring-agricultural-crop-500",
...
export const DETAILS_ALERTS = {
  success: "p-3 bg-agricultural-crop-50 border border-agricultural-crop-200 rounded-md text-agricultural-crop-800 animate-slide-up",
  error: "p-3 bg-red-50 border border-red-200 rounded-md text-red-800 animate-slide-up",
  warning: "p-3 bg-agricultural-machinery-50 border border-agricultural-machinery-200 rounded-md text-agricultural-machinery-800 animate-slide-up",
