...
export const LAYOUT_STYLES = {
  ...
  gridFilters: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-3",
  gridButtons: "grid grid-cols-1 gap-3 mt-3",
...
export const LIST_STYLES = {
  ...
  itemTag: "flex items-center justify-center gap-1 px-2 py-1 rounded-md text-[12px] sm:text-sm font-medium tag-no-wrap flex-1 min-w-[60px]",
  itemTagStock: "flex items-center gap-1 px-2 py-1 rounded-md text-[12px] sm:text-sm font-medium tag-no-wrap flex-shrink-0 min-w-[45px] max-w-[70px]",
  itemTagCategory: "flex items-center justify-center gap-1 px-1.5 py-1 rounded-md text-[12px] sm:text-sm font-medium tag-no-wrap flex-1 min-w-[70px] max-w-[200px] sm:max-w-[220px] md:max-w-[240px] lg:flex-initial lg:max-w-none",
  itemTagWithEllipsis: "flex items-center justify-center gap-1 px-1.5 py-1 rounded-md text-[12px] sm:text-sm font-medium tag-no-wrap flex-1 min-w-[80px] max-w-[180px] sm:max-w-[200px] md:max-w-[220px] lg:flex-initial lg:max-w-none",
  itemTagCode: "flex items-center justify-center gap-1 px-1.5 py-1 rounded-md text-[12px] sm:text-sm font-medium tag-no-wrap flex-1 min-w-[80px] max-w-[180px] sm:max-w-[200px] md:max-w-[220px] lg:flex-initial lg:max-w-none",
  itemTagLocation: "flex items-center justify-center gap-1 px-1.5 py-1 rounded-md text-[12px] sm:text-sm font-medium tag-no-wrap flex-1 min-w-[70px] max-w-[200px] sm:max-w-[220px] md:max-w-[240px] lg:flex-initial lg:max-w-none",
  itemTagSupplier: "flex items-center justify-center gap-1 px-1.5 py-1 rounded-md text-[12px] sm:text-sm font-medium tag-no-wrap flex-1 min-w-[80px] max-w-[200px] sm:max-w-[220px] md:max-w-[240px] lg:flex-initial lg:max-w-none",
  itemDescription: "text-[15px] text-gray-700 mt-1 font-medium line-clamp-2 flex items-center justify-between gap-2 min-h-[24px]",
