...
echo "   - API: https://sistemagestionagricola-api.onrender.com"
echo "   - Frontend: https://sistemagestionagricola.onrender.com"
echo "   - Health Check: https://sistemagestionagricola-api.onrender.com/api/health"
echo ""
